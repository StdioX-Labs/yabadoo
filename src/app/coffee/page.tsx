...
export default function CoffeePage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log('Coffee payment submitted:', { ...formData, amount, paymentMethod: activeTab });
    alert(`Processing ${activeTab.toUpperCase()} payment of KES ${amount}...\nThank you for supporting Yaba! ☕`);
  };
            ...
            <div className="p-6 sm:p-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <p className="text-xs text-center text-[#F0FFF0]/50">
                  Thank you for supporting Yaba&apos;s music! 🎵
                </p>
              </form>
            </div>
          </div>
