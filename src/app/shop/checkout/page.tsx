...
import { CreditCard, Phone, Shield, Check, X, Loader2, ChevronLeft, Tag, Music, Download } from 'lucide-react';
...
const EP_DATA = {
    ...
    artist: 'YABA',
    trackCount: 6,
    coverImage: '/images/ep-cover.jpg',
    currency: 'KES',
};
...
export default function ShopCheckoutPage() {
    ...
    const calculateSubtotal = () => EP_PRICE;
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#0A0F0D] p-4">
                <div className="bg-[#0D1311] border border-[#708238] rounded-lg p-8 max-w-md w-full">
                    <div className="flex flex-col items-center text-center">
                        ...
                        <h3 className="text-3xl font-bold mb-2 text-[#F0FFF0]">PURCHASE COMPLETE!</h3>
                        <p className="text-[#F0FFF0]/60 mb-4">
                            Your {EP_DATA.title} EP has been purchased successfully!
                        </p>
                        <div className="w-full bg-[#708238]/10 border border-[#708238]/30 rounded-lg p-4 mb-8">
                            <div className="flex items-start gap-3">
                                <Download className="w-5 h-5 text-[#708238] mt-0.5 flex-shrink-0" />
                                <div className="text-left">
                                    <p className="text-sm font-medium text-[#F0FFF0] mb-1">
                                        Download link sent!
                                    </p>
                                    <p className="text-xs text-[#F0FFF0]/60">
                                        Check {formData.email} for your download link and receipt.
                                        {paymentMethod === 'mpesa' && ` Also sent to ${countryCode}${mpesaNumber.slice(0, -3)}XXX.`}
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <header className="sticky top-0 left-0 right-0 z-40 bg-[#0A0F0D]/95 backdrop-blur-xl border-b border-[#708238]/20">
                    <div className="container mx-auto px-4 py-4 flex items-center justify-between">
                        <Link href="/shop" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
                            ...
                            <span className="text-[#F0FFF0] text-sm">Back to Shop</span>
                        </Link>
                        ...
                        {step === 1 && (
                            <div className="space-y-6">
                                ...
                                <div className="border-t border-[#708238]/30 pt-6 mt-8">
                                    ...
                                    <div className="bg-[#0D1311] border border-[#708238]/30 rounded-lg p-4 mb-4">
                                        <div className="flex items-start gap-4">
                                            <div className="w-16 h-16 rounded-lg bg-[#708238]/20 flex items-center justify-center flex-shrink-0">
                                                <Music className="w-8 h-8 text-[#708238]" />
                                            </div>
                                            <div className="flex-1">
                                                <h5 className="font-bold text-[#F0FFF0]">{EP_DATA.title}</h5>
                                                <p className="text-sm text-[#F0FFF0]/60">by {EP_DATA.artist}</p>
                                                <p className="text-xs text-[#F0FFF0]/40 mt-1">{EP_DATA.trackCount} tracks • Digital Download</p>
                                            </div>
                                            <div className="text-right">
                                                <p className="font-bold text-[#F0FFF0]">{EP_DATA.currency} {EP_PRICE.toLocaleString()}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="flex justify-between font-bold text-xl text-[#F0FFF0]">
                                        ...
                                        <span className="text-[#708238]">
                                            {EP_DATA.currency} {EP_PRICE.toLocaleString()}
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="border-t border-[#708238]/30 pt-6">
                                        ...
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <details className="mt-2">
                                                    <summary className="text-xs text-[#708238] cursor-pointer hover:underline">
                                                        View {EP_DATA.trackCount} tracks
                                                    </summary>
                                                    <ul className="mt-2 space-y-1">
                                                        {tracks.map((track, index) => (
                                                            <li key={index} className="text-xs text-[#F0FFF0]/50">
                                                                {index + 1}. {track}
                                                            </li>
                                                        ))}
                                                    </ul>
                                    ...
                                    <div className="space-y-3 mb-4">
                                        <div className="border-t border-[#708238]/20 pt-2">
                                            <div className="flex justify-between text-sm text-[#F0FFF0]/80">
                                                <span>Subtotal</span>
                                                <span>{EP_DATA.currency} {calculateSubtotal().toLocaleString()}</span>
                                            </div>
                                        </div>
                                        {promoCodeApplied && (
                                            <div className="flex justify-between text-sm text-[#708238]">
                                                <span>Discount ({promoDiscount}%)</span>
                                                <span>-{EP_DATA.currency} {calculateDiscount().toLocaleString()}</span>
                                            </div>
                                        )}
                                    </div>
                                    <div className="flex justify-between font-bold text-xl pt-2 border-t border-[#708238]/30 text-[#F0FFF0]">
                                        <span>TOTAL</span>
                                        <span className="text-[#708238]">
                                            {EP_DATA.currency} {calculateFinalTotal().toLocaleString()}
                                        </span>
                                    </div>
                                </div>
